...
const MapJSX = ({
   ...
   const mapShapes = PhilippineMapShapes.find(shapes => shapes.place === mapOfPlace);
   ...
   return (
      <>
         ...
         >
            ...
            <g transform={
               "translate(" + mapShapes.mapTransformTranslate.X + "," + mapShapes.mapTransformTranslate.Y + ")"
            }>
            ...
            <g
               ...
               transform={
                  "matrix(1.63481 0 0 1.6089 " + mapShapes.legendTransformMatrix.X + " " + mapShapes.legendTransformMatrix.Y + ")"
               }
            >
               <rect
                  id="rect385"
